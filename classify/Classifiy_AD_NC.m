...
load DRdata.mat
%%
DRdata1 = DRdata(:,1:147);         % AD,NC : 350*(147+430) 
DRdata2 = DRdata(:,288:717); 
DRdata = [DRdata1,DRdata2];
data = DRdata';
label = zeros(577,2);               % 287 * 2
label(1:147,2) = ones(147,1);       % 第二列前147个令为1
label(148:577,1) = ones(430,1);     % 第二列后430个令为1

randIndex = randperm(577);
